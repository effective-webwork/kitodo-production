...
import org.kitodo.data.database.converter.ProcessPriorityConverter;
...
public class Process extends BaseTemplateBean {
    ...
    @Convert(converter = ProcessPriorityConverter.class)
    private ProcessPriority priority = ProcessPriority.NORMAL;

    @Column(name = "structuralError")
    private boolean structuralError;

    @Column(name = "missingInformation")
    private boolean missingInformation;

    @Column(name = "reimport")
