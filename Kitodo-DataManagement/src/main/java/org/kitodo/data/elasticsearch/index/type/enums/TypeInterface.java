...
interface TypeInterface {
    ...
    /**
     * Get LocalDateTime value from given json object.
     *
     * @param jsonObject
     *          returned from ElasticSearch index
     * @return java.time.LocalDateTime object for given json object
     */
    default LocalDateTime getLocalDateTimeValue(Map<String, Object> jsonObject) throws DataException {
        String dateString = getStringValue(jsonObject);
