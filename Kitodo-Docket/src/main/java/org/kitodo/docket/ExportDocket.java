...
public class ExportDocket {
    ...
    void startExport(List<StandardPartialJobDocketData> partialJobDocketDataList, OutputStream os, boolean compact) throws IOException {
        ExportXmlLog exl = new ExportXmlLog(new ArrayList<>());
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        exl.startExport(partialJobDocketDataList, out, compact);
