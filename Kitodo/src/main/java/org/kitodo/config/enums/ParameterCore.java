...
public enum ParameterCore implements ParameterInterface {
    ...
    /**
     * Subdirectory where the scanned images should be placed in "Vecteur" project.
     */
    SCANNED_IMAGES_SUBDIR(new Parameter<>("scanned_images_subdir_name", "scanned_images")),

    /**
     * Directory where the PNG files of the preview images are stored.
     */
    PREVIEW_IMAGES_DIR(new Parameter<>("directory.preview_images", "var/lib/tomcat8/webapps/kitodo/images/")),

    /**
     * Directory where the user should see his home directory.
     */
    HOME_DIRECTORY_LOCATION(new Parameter<>("homedirectory_location", "")),
    ...
    /**
     * Show last comment in process and task list
     */
    ...
    /**
     * Default keyboard shortcuts for each user. These are only used if a user has not specified individual shortcuts.
     */
    DEFAULT_USER_SHORTCUTS(new Parameter<>("defaultUserShortcuts",
            "{\"detailView\":\"Control Shift *\",\"downItem\":\"ArrowDown\",\"downItemMulti\":\"Shift ArrowDown\",\"help\":\"Shift ?\",\"nextItem\":\"ArrowRight\",\"nextItemMulti\":\"Shift ArrowRight\",\"previousItem\":\"ArrowLeft\",\"previousItemMulti\":\"Shift ArrowLeft\",\"structuredView\":\"Control Shift _\",\"upItem\":\"ArrowUp\",\"upItemMulti\":\"Shift ArrowUp\"}")),
