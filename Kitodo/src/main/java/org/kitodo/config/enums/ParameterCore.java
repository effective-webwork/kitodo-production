...
public enum ParameterCore implements ParameterInterface {
     ...
     * When more data records are imported the import process is moved to a background task. Default value is 30.
     */
    MAX_NUMBER_OF_PROCESSES_FOR_IMPORT_MASK(new Parameter<>("maxNumberOfProcessesForImportMask", 30));
