...
public class AuthorityForm extends BaseForm {
    ...
    private String originalAuthorityTitle;
    ...
    public String save() {
        try {
            ...
            logChanges(this.originalAuthorityTitle, this.authority);
            return usersPage;
    ...
    public void delete() {
        try {
            ...
            logger.info(AuditingLogger.createObjectSaveOrDeleteLogEntry(LogEntryType.DELETE,
                    ObjectType.AUTHORITY.getMessageKeySingular(), this.authority.getTitle(), this.authority.getId()));
        } catch (DAOException e) {
    ...
    public void setAuthority(Authority authority) {
        ...
        this.originalAuthorityTitle = this.authority.getTitle();
    }
    ...
    private void logChanges(String originalTitle, Authority newAuthority) {
        if (!Objects.equals(newAuthority.getTitle(), originalTitle)) {
            logger.info(AuditingLogger.createFieldUpdateLogEntry("title", originalTitle, newAuthority.getTitle(),
                    ObjectType.AUTHORITY.getMessageKeySingular(), originalTitle, newAuthority.getId()));
        }
        logger.info(AuditingLogger.createObjectSaveOrDeleteLogEntry(LogEntryType.SAVE,
                ObjectType.AUTHORITY.getMessageKeySingular(), newAuthority.getTitle(), newAuthority.getId()));
    }
}
