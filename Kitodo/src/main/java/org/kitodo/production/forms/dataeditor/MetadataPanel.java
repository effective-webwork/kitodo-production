...
public class MetadataPanel implements Serializable {
    ...
    public void preserveLogical() throws InvalidMetadataValueException, NoSuchMetadataFieldException {
        logicalMetadataTable.preserve();
        dataEditorForm.checkForChanges();
    }

    public void preservePhysical() throws InvalidMetadataValueException, NoSuchMetadataFieldException {
