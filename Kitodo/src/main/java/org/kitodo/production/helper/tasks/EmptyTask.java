...
public class EmptyTask extends Thread {
    ...
    protected EmptyTask(EmptyTask master) {
        ...
        this.remainingTime = master.remainingTime;
    ...
    public void predictRemainingTime() {
        long progressedTime = System.nanoTime() - this.startTime;
        long predictedTime = (progressedTime / this.getProgress()) * 100;
        this.remainingTime = (predictedTime - progressedTime) / 1000000000;
    }
