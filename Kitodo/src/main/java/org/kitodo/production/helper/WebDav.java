...
public class WebDav implements Serializable {
    ...
    public void downloadToHome(Process process, boolean onlyRead) {
        ...
        try {
            String subdir = ConfigCore.getParameterOrDefaultValue(ParameterCore.SCANNED_IMAGES_SUBDIR);
            source = fileService.getImagesDirectory(process).resolve(subdir);
     ...
     */
    public String getProcessLinkName(Process process) {
