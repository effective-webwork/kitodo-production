...
public class ImportEadProcessesThread extends EmptyTask {
    ...
    // FIXME: xml files with default namespace (e.g. "A_20_Altwürttembergisches_...") seem to contain default ns uri
    //        before each tag name which breaks the parser! (this method is just a workaround)
