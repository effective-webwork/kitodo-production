...
public class MetadataEditor {
    ...
    public static PhysicalDivision addPhysicalDivision(String type, Workpiece workpiece, PhysicalDivision parent,
        ...
        PhysicalDivision newPhysicalDivision = new PhysicalDivision(workpiece);
    ...
    public static LogicalDivision getRootDossier(LogicalDivision topstruct) {
        return getRootElementOfType(topstruct, DOSSIER);
    }

    public static LogicalDivision getRootElementOfType(LogicalDivision docRoot, String type) {
        LogicalDivision rootElement = null;
        for (LogicalDivision currentDocStruct : docRoot.getChildren()) {
            if (currentDocStruct.getType().equals(type)) {
    ...
    public static LinkedList<HashMap<String, String>> getRootDossierMetadata(LogicalDivision element) {
        LinkedList<HashMap<String, String>> rootDossierMetadata = new LinkedList<>();
        LogicalDivision dossier = getRootDossier(element);
        if (Objects.nonNull(dossier)) {
            for (Metadata metadata : dossier.getMetadata()) {
                if (metadata instanceof MetadataEntry) {
                    ...
                    rootDossierMetadata.add(metadataMap);
                }
            }
        }
        return rootDossierMetadata;
    }

    /**
     * Move View 'view' from LogicalDivision 'fromElement' to LogicalDivision 'toElement'.
     *
     * @param view
     *          View that will be moved
     * @param fromElement
     *          LogicalDivision from which the View will be moved
     * @param toElement
     *          LogicalDivision to which the View will be moved
     */
    public static void moveView(View view, LogicalDivision fromElement, LogicalDivision toElement) {
