...
public class SecurityAccessController {
    ...
    /**
     * Check if the current user has the authority to cancel digitization jobs.
     *
     * @return true if the current user has the authority to cancel digitization jobs.
     */
    public boolean hasAuthorityToCancelJobs() {
        return securityAccessService.hasAuthorityToCancelJobs();
    }

    /**
     * Check if the current user has the authority to view correction tasks.
     *
     * @return true if the current user has the authority to view correction tasks.
     */
    public boolean hasAuthorityToViewCorrectionTasks() {
        return securityAccessService.hasAuthorityToViewCorrectionTasks();
    }
}
