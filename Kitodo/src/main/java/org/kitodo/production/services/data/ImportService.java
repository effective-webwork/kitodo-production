...
public class ImportService {
    ...
    public LinkedList<TempProcess> parseImportedEADCollection(DataRecord importedEADRecord,
        ...
        List<Element> collectionElements = getEADElements(eadCollectionDocument, eadParentProcessLevel);
        List<Element> fileElements = getEADElements(eadCollectionDocument, eadChildProcessLevel);
        ...
        // TODO: is this check still required? (already done in "FileUploadDialog")
