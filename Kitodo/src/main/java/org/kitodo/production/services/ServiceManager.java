...
import org.kitodo.production.services.data.ReportService;
...
public class ServiceManager {
    ...
    private static void initializeReportService() {
    ...
    /**
     * Initialize ReportService if it is not yet initialize and return it.
     *
