...
public class IndexingService {
    ...
    public String deleteIndex() {
        try {
            ...
            logger.info("Index deleted by user "
    ...
    void logIndexingAllFinished() {
        logger.info("Indexing all objects finished (started by user " + this.indexingStartedUser + ").");
    }
    ...
    public String getIndexingStartedUser() {
        return this.indexingStartedUser;
    }

    public void setIndexingStartedUser(String user) {
        this.indexingStartedUser = user;
    }
}
