...
public class ProjectService extends ClientSearchService<Project, ProjectDTO, ProjectDAO> {
    ...
    /**
     * Detect and return changes between two given projects.
     *
     * @param oldProject first Project
     * @param newProject second Project
     * @return map containing the names of the changed fields with old and new values
     */
    public static HashMap<String, Pair<String, String>> detectChanges(Project oldProject, Project newProject) {
        HashMap<String, Pair<String, String>> changes = new HashMap<>();
        if (!Objects.equals(oldProject.getTitle(), newProject.getTitle())) {
            changes.put("title", Pair.of(oldProject.getTitle(), newProject.getTitle()));
        }
        if (!Objects.equals(oldProject.getNumberOfPages(), newProject.getNumberOfPages())) {
            changes.put("numberOfPages", Pair.of(String.valueOf(oldProject.getNumberOfPages()), String.valueOf(newProject.getNumberOfPages())));
        }
        if (!Objects.equals(oldProject.getNumberOfVolumes(), newProject.getNumberOfVolumes())) {
            changes.put("numberOfVolumnes", Pair.of(String.valueOf(oldProject.getNumberOfVolumes()), String.valueOf(newProject.getNumberOfVolumes())));
        }
        if (!oldProject.getStartDate().equals(newProject.getStartDate())) {
            changes.put("startDate", Pair.of(String.valueOf(oldProject.getStartDate()), String.valueOf(newProject.getStartDate())));
        }
        if (!oldProject.getEndDate().equals(newProject.getEndDate())) {
            changes.put("endDate", Pair.of(String.valueOf(oldProject.getEndDate()), String.valueOf(newProject.getEndDate())));
        }
        if (oldProject.isActive() != newProject.isActive()) {
            changes.put("isActive", Pair.of(String.valueOf(oldProject.isActive()), String.valueOf(newProject.isActive())));
        }
        if (!Objects.equals(oldProject.getDmsImportRootPath(), newProject.getDmsImportRootPath())) {
            changes.put("dmsImportRootPath", Pair.of(oldProject.getDmsImportRootPath(), newProject.getDmsImportRootPath()));
        }
        if (!Objects.equals(oldProject.getMetsRightsOwner(), newProject.getMetsRightsOwner())) {
            changes.put("metsRightsOwner", Pair.of(oldProject.getMetsRightsOwner(), newProject.getMetsRightsOwner()));
        }
        if (!Objects.equals(oldProject.getMetsRightsOwnerSite(), newProject.getMetsRightsOwnerSite())) {
            changes.put("metsRightsOwnerSite", Pair.of(oldProject.getMetsRightsOwnerSite(), newProject.getMetsRightsOwnerSite()));
        }
        if (!Objects.equals(oldProject.getMetsDigiprovReference(), newProject.getMetsDigiprovReference())) {
            changes.put("metsDigiprovReference", Pair.of(oldProject.getMetsDigiprovReference(), newProject.getMetsDigiprovReference()));
        }
        if (!Objects.equals(oldProject.getMetsPointerPath(), newProject.getMetsPointerPath())) {
            changes.put("metsPointerPath", Pair.of(oldProject.getMetsPointerPath(), newProject.getMetsPointerPath()));
        }
        if (!Objects.equals(oldProject.getMetsPurl(), newProject.getMetsPurl())) {
            changes.put("metsPurl", Pair.of(oldProject.getMetsPurl(), newProject.getMetsPurl()));
        }
        if (!Objects.equals(oldProject.getMetsRightsOwnerLogo(), newProject.getMetsRightsOwnerLogo())) {
            changes.put("metsRightsOwnerLogo", Pair.of(oldProject.getMetsRightsOwnerLogo(), newProject.getMetsRightsOwnerLogo()));
        }
        if (!Objects.equals(oldProject.getMetsRightsOwnerMail(), newProject.getMetsRightsOwnerMail())) {
            changes.put("metsRightsOwnerMail", Pair.of(oldProject.getMetsRightsOwnerMail(), newProject.getMetsRightsOwnerMail()));
        }
        if (!Objects.equals(oldProject.getMetsDigiprovPresentation(), newProject.getMetsDigiprovPresentation())) {
            changes.put("metsDigiprovPresentation", Pair.of(oldProject.getMetsDigiprovPresentation(), newProject.getMetsDigiprovPresentation()));
        }
        if (!Objects.equals(oldProject.getMetsContentIDs(), newProject.getMetsContentIDs())) {
            changes.put("metsContentIDs", Pair.of(oldProject.getMetsContentIDs(), newProject.getMetsContentIDs()));
        }
        return changes;
    }
}
