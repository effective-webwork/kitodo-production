...
public class LazyTaskDTOModel extends LazyDTOModel {
    ...
    private ProcessPriority processPriorityRestriction = null;
        ...
        if (indexRunning()) {
            try {
                ...
                setRowCount(toIntExact(((TaskService)searchService).countResults(filterMap, this.onlyOwnTasks,
                        ...
                        this.processPriorityRestriction)));
                entities = ((TaskService)searchService).loadData(first, pageSize, sortField, sortOrder, filterMap,
                        ...
                        this.taskStatusRestriction, this.processPriorityRestriction);
    ...
    public ProcessPriority getProcessPriorityRestriction() {
        return processPriorityRestriction;
    }
    ...
    public void setProcessPriorityRestriction(ProcessPriority processPriorityRestriction) {
        this.processPriorityRestriction = processPriorityRestriction;
    }
