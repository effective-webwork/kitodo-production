...
public class LazyProcessDTOModel extends LazyDTOModel {
    ...
    private ProcessPriority priorityRestriction = null;
    ...
    public void setPriorityRestriction(ProcessPriority priorityRestriction) {
        this.priorityRestriction = priorityRestriction;
    }
        ...
        if (indexRunning()) {
            try {
                ...
                setRowCount(toIntExact(((ProcessService)searchService).countResults(filterMap, this.showClosedProcesses,
                        this.showInactiveProjects, this.priorityRestriction)));

                entities = ((ProcessService)searchService).loadData(first, pageSize, sortField, sortOrder, filterMap,
                        this.showClosedProcesses, this.showInactiveProjects, this.priorityRestriction);
