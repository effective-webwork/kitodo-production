...
public class LogicalStructMapType extends StructMapType {
     ...
     */
    public DivType addNewDiv(DivType presentDiv, String type, PositionOfNewDiv position) {
        DivType newDiv = addNewLogicalDivToExistingDiv(presentDiv, type, position);
        generateIdsForDivs();
     ...
     */
    private DivType addNewLogicalDivToExistingDiv(DivType existingDiv, String type,
     ...
     * object.
     */
    public void generateIdsForDivs() {
    ...
    public int getLogicalStructMapSize() {
        int size = 0;
        if (Objects.nonNull(super.getDiv())) {
            List<DivType> divTypes = super.getDiv().getDiv();
            if (!divTypes.isEmpty()) {
                size = getSizeOfDivTypes(divTypes, 1);
            }
        }
        return size;
    }
