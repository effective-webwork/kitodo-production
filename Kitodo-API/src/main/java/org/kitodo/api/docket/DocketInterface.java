...
public interface DocketInterface {
    ...
    File generateStandardPartialJobDockets(List<StandardPartialJobDocketData> standardPartialJobDocketDataList, URI xslFileUri) throws IOException;

    File generatePartialJobList(List<StandardPartialJobDocketData> standardPartialJobDocketData, URI xslFileUri) throws IOException;
}
