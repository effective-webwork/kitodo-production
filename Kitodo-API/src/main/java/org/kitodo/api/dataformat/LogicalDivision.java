...
public class LogicalDivision extends Division<LogicalDivision> {
    ...
    /**
     * Returns the ID of div.
     *
     * @return the ID of div
     */
    public String getId() {
        // TODO: once we have a proper metadata to identify Structural elements in the frontend, remove this workaround method!
        try {
            Method getID = this.getClass().getMethod("getDivId", (Class<?>[]) null);
            return (String) getID.invoke(this, (Object[]) null);
        } catch (NoSuchMethodException e) {
            System.err.println("Selected structural element does not have a 'getDivID' method!");
