...
public class Workpiece {
     ...
     * type "page", "track" or "other" sorted by their {@code order} as a flat list. The root media
     ...
     */
    public List<PhysicalDivision> getAllPhysicalDivisionChildrenSortedFilteredByPageAndTrackAndOther() {
        return getAllPhysicalDivisionChildrenFilteredByTypes(
                Arrays.asList(PhysicalDivision.TYPE_PAGE, PhysicalDivision.TYPE_TRACK, PhysicalDivision.TYPE_OTHER));
    }
