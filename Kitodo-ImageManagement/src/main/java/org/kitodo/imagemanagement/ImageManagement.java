...
public class ImageManagement implements ImageManagementInterface {
    ...
    @Override
    public void createCustomImage(String parameterLine, int processID, String creator, String signature) {
        VecteurImageConverter converter = new VecteurImageConverter(processID, creator, signature);
        converter.callImageServer(parameterLine);
    }
